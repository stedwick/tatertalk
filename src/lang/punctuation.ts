...
const preserveSpecialCases = (context: PunctuationContext): PunctuationContext => ({
  ...context,
  text: context.text
...
const applyPunctuationMap = (context: PunctuationContext): PunctuationContext => ({
  ...context,
...
const applySpecialRules = (context: PunctuationContext): PunctuationContext => ({
  ...context,
  text: context.text
...
const capitalizeFirstLetter = (context: PunctuationContext): PunctuationContext => ({
  ...context,
...
const capitalizeWithinUtterance = (context: PunctuationContext): PunctuationContext => ({
  ...context,
  text: context.text.replace(charsThatCapitalizeNextRegex, (_match, p1, p2) => p1 + p2.toUpperCase())
})

const removeSpacesBefore = (context: PunctuationContext): PunctuationContext => ({
  ...context,
  text: context.text.replace(charsWithOnlySpaceBeforeRegex, "$1")
})

const removeSpacesAfter = (context: PunctuationContext): PunctuationContext => ({
  ...context,
...
const restoreSpecialCases = (context: PunctuationContext): PunctuationContext => ({
  ...context,
  text: context.text
...
const debugLogStep = (stepName: string) => (context: PunctuationContext): PunctuationContext => {
  if (debugLog) {
