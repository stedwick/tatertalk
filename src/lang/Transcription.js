...
function Transcription() {
  ...
  const createRecognizer = useCallback((audioStream) => {
  ...
  }, [createRecognizer, stopRecognizer])
  ...
  return (
    <header className="App-header">
      <img
        src={logo}
        className={isRecognising ? "App-logo App-logo-rotate" : "App-logo"}
        alt="Microsoft Logo"
      />
          ...
          <Form>
            ...
            <Stack direction="horizontal" gap={2}>
              ...
              {recognisedText !== "" && !isRecognising && (
                <Button
                  variant="secondary"
                  onClick={() => export2txt(recognisedText)}
                >
                  Export
                </Button>
              )}
